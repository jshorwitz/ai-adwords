...
def generate_historical_campaign_data(customer_id: str, days_back: int = 365) -> pd.DataFrame:
    ...
    campaigns = [
        {"id": "123456789", "name": "Brand Campaign", "base_impressions": 5000, "base_ctr": 0.08, "seasonality": 0.1},
        {"id": "234567890", "name": "Search Campaign", "base_impressions": 8000, "base_ctr": 0.05, "seasonality": 0.15},
        {"id": "345678901", "name": "Display Campaign", "base_impressions": 12000, "base_ctr": 0.02, "seasonality": 0.2},
        {"id": "456789012", "name": "Shopping Campaign", "base_impressions": 3000, "base_ctr": 0.12, "seasonality": 0.25},
        {"id": "567890123", "name": "Video Campaign", "base_impressions": 15000, "base_ctr": 0.03, "seasonality": 0.1}
    ]
    ...
    for date in date_range:
        ...
        for campaign in campaigns:
            ...
            impressions = int(base_impressions * day_of_week_multiplier * 
...
def generate_historical_keyword_data(customer_id: str, days_back: int = 365) -> pd.DataFrame:
    ...
    keywords = [
        # Brand keywords
        {"text": "your brand name", "campaign_id": "123456789", "ad_group_id": "111111111", "match_type": "EXACT", "quality_score": 9, "base_impressions": 500},
        {"text": "your company", "campaign_id": "123456789", "ad_group_id": "111111111", "match_type": "PHRASE", "quality_score": 8, "base_impressions": 300},
        
        # Search keywords
        {"text": "best software solution", "campaign_id": "234567890", "ad_group_id": "222222222", "match_type": "BROAD", "quality_score": 6, "base_impressions": 800},
        {"text": "enterprise software", "campaign_id": "234567890", "ad_group_id": "222222222", "match_type": "PHRASE", "quality_score": 7, "base_impressions": 600},
        {"text": "business automation", "campaign_id": "234567890", "ad_group_id": "333333333", "match_type": "BROAD", "quality_score": 5, "base_impressions": 400},
        
        # Shopping keywords
        {"text": "buy software online", "campaign_id": "456789012", "ad_group_id": "444444444", "match_type": "PHRASE", "quality_score": 8, "base_impressions": 200},
        {"text": "software deals", "campaign_id": "456789012", "ad_group_id": "444444444", "match_type": "BROAD", "quality_score": 6, "base_impressions": 350},
    ]
    ...
    for date in date_range:
        ...
        for i, keyword in enumerate(keywords):
            ...
            impressions = int(keyword["base_impressions"] * day_of_week_multiplier * random_variation)
